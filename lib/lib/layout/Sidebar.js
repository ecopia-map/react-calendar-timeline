  ...
  _createClass(Sidebar, [{
    ...
    value: function render() {
      ...
      var groupLines = this.props.groups.map(function (group, index) {
        ...
        return _this.props.allowGroupDraggable ? _react["default"].createElement(_reactBeautifulDnd.Draggable, {
          key: "".concat(group[groupIdKey]),
          draggableId: "".concat(group[groupIdKey]),
          index: index
          ...
          return _react["default"].createElement("div", _extends({
            ...
            style: _objectSpread({}, elementStyle, {}, provided.draggableProps.style)
          }), _this.renderGroupContent(group, isRightSidebar, groupTitleKey, groupRightTitleKey));
        }) : _react["default"].createElement("div", {
          key: (0, _generic._get)(group, groupIdKey),
          className: 'rct-sidebar-row rct-sidebar-row-' + (index % 2 === 0 ? 'even' : 'odd'),
          style: _objectSpread({}, elementStyle)
        }, _this.renderGroupContent(group, isRightSidebar, groupTitleKey, groupRightTitleKey));
      });
      return _react["default"].createElement("div", {
        className: 'rct-sidebar' + (isRightSidebar ? ' rct-sidebar-right' : ''),
        style: sidebarStyle
      }, this.props.allowGroupDraggable ? _react["default"].createElement(_reactBeautifulDnd.DragDropContext, {
        ...
        isCombineEnabled: this.props.isGroupCombineEnabled
      }, function (provided, snapshot) {
        return _react["default"].createElement("div", _extends({
          style: groupsStyle
        }, provided.droppableProps, {
          ref: provided.innerRef
        }), groupLines, provided.placeholder);
      })) : _react["default"].createElement("div", {
        style: groupsStyle
      }, groupLines));
    }
...
_defineProperty(Sidebar, "propTypes", {
  ...
  allowGroupDraggable: _propTypes["default"].bool,
  onDragEnd: _propTypes["default"].func,
  onDragStart: _propTypes["default"].func,
  onDragUpdate: _propTypes["default"].func,
  onBeforeCapture: _propTypes["default"].func,
  onBeforeDragStart: _propTypes["default"].func,
  isGroupCombineEnabled: _propTypes["default"].bool
});